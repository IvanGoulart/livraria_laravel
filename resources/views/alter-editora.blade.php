                ...
                <ul class="nav navbar-nav" id="link-white">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">                           
                            ...
                            <li><a href="{{route('product.index')}}">Editora</a></li>                                               
        ...
        <div id="line-one">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="{{route('editora.index')}}">Editora</a></li>                  
                ...
                <div class="row">  
                    ...
                    <br> 
                    <form method="post" 
                          action="{{route('editora.update', $product_editora->id)}}" 
                        ...
                        <div class="col-md-6">              
                            <div class="form-group">
                                ...
                                <input type="text" name="name" 
                                       class="form-control" 
                                       value="{{$product_editora->name or old('name')}}"
                                       required>
                            </div>
                        </div>
                        <div class="col-md-12">                   
